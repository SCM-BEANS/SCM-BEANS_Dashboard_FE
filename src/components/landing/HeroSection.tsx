...
export function HeroSection() {
  return (
    <section className="relative w-full h-screen flex items-center justify-center overflow-hidden bg-black" id="home">
      {/* Background — real coffee shop / machine */}
      <div
      ...
      <div className="relative z-10 text-center flex flex-col items-center px-4 w-full max-w-5xl mx-auto">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <span className="text-white/70 text-xs tracking-[0.3em] uppercase font-semibold">
            Coffee Machine as a Service
          </span>
          <div className="w-8 h-px bg-white/60"></div>
        </div>

        <h1 className="text-white text-5xl md:text-7xl font-black tracking-tight uppercase mb-6 drop-shadow-lg leading-tight">
          Rent. Connect.<br />
          <span className="text-white/80">Brew Smarter.</span>
        </h1>

        <p className="text-white/80 text-lg md:text-xl font-light tracking-wide mb-12 max-w-2xl">
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center">
          <Link
            href="/solutions"
            id="hero-explore-btn"
            className="group inline-flex items-center gap-3 px-8 py-4 bg-white text-black rounded-full font-bold uppercase tracking-widest text-sm hover:bg-white/90 transition-all duration-300"
          >
            Khám phá giải pháp
          ...
          <Link
            href="/login"
            id="hero-login-btn"
            className="inline-flex items-center gap-3 px-8 py-4 border border-white/50 text-white rounded-full font-bold uppercase tracking-widest text-sm hover:bg-white/10 transition-all duration-300"
          >
            Đăng nhập Dashboard
          </Link>
        </div>
        ...
        <div className="flex gap-8 sm:gap-16 mt-16 pt-8 border-t border-white/20 text-center">
          <div>
            ...
            <div className="text-white/60 text-xs tracking-widest uppercase mt-1">Máy đang hoạt động</div>
          </div>
          <div>
            <div className="text-white text-3xl font-black">99.9%</div>
            <div className="text-white/60 text-xs tracking-widest uppercase mt-1">Uptime SLA</div>
          </div>
          <div>
            <div className="text-white text-3xl font-black">50+</div>
            <div className="text-white/60 text-xs tracking-widest uppercase mt-1">Khách hàng doanh nghiệp</div>
          </div>
        </div>
      </div>
