...
export const InventoryWidget = () => {
  ...
  return (
    <section className="flex flex-col gap-6">
      <div className="text-xl font-bold uppercase border-b-2 border-outline pb-2 text-primary">Inventory Levels</div>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-full">
        <div className="bento-border p-6 flex flex-col justify-between hover:border-primary transition-colors">
          <div className="flex justify-between items-start mb-4">
            <span className="font-mono text-sm uppercase text-on-surface-variant">Coffee Beans</span>
          ...
          <div>
            ...
            <div className="w-full border-t-2 border-outline mt-4 pt-2 font-mono text-xs uppercase flex justify-between text-on-surface-variant">
              <span>Capacity: {inventory.coffeeBeans.capacity}{inventory.coffeeBeans.unit}</span>
        ...
        <div className="bento-border p-6 flex flex-col justify-between hover:border-secondary transition-colors">
          <div className="flex justify-between items-start mb-4">
            <span className="font-mono text-sm uppercase text-on-surface-variant">Water Volume</span>
          ...
          <div>
            ...
            <div className="w-full border-t-2 border-outline mt-4 pt-2 font-mono text-xs uppercase flex justify-between text-on-surface-variant">
              <span>{inventory.water.isMainsConnected ? 'Mains Connected' : 'Tank Mode'}</span>
        ...
        <div className="bento-border p-6 flex flex-col justify-between hover:border-primary transition-colors">
          <div className="flex justify-between items-start mb-4">
            <span className="font-mono text-sm uppercase text-on-surface-variant">Milk Inventory</span>
